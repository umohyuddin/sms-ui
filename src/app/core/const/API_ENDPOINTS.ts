export const API_ENDPOINTS: any = {
    ...
    DISCOUNT: {
        DISCOUNT_TYPE: {
            ...
            SEARCH: (keyword: string) => `/api/school/discounts/types/search?keyword=${keyword}`,
            GET_BY_ID: (id: string | number) => `/api/school/discounts/types/${id}`,
            UPDATE: (id: string | number) => `/api/school/discounts/types/${id}`,
            GET_ACTIVE: '/api/school/discounts/types/active',
            GET_INACTIVE: '/api/school/discounts/types/inactive',
        },
        DISCOUNT_SUB_TYPE: {
            CREATE: '/api/school/discounts/subtypes',
            UPDATE: (id: string | number) => `/api/school/discounts/subtypes/${id}`,
            GET_ALL: '/api/school/discounts/subtypes',
            SEARCH: (discountTypeId?: string | number, keyword?: string) => `/api/school/discounts/subtypes/search?${discountTypeId ? `discountTypeId=${discountTypeId}&` : ''}${keyword ? `keyword=${keyword}` : ''}`,
            GET_BY_ID: (id: string | number) => `/api/school/discounts/subtypes/${id}`,
            GET_BY_CONCESSION_TYPE: (id: string | number) => `/api/school/discounts/subtypes/byDiscountType/${id}`,
            ACTIVATE: (id: string | number) => `/api/school/discounts/subtypes/${id}/activate`,
            DEACTIVATE: (id: string | number) => `/api/school/discounts/subtypes/${id}/deactivate`,
            DELETE_ALL: '/api/school/discounts/subtypes/all',
        },
        DISCOUNT_RATES: {
            CREATE: '/api/school/discounts/rates',
            UPDATE: (id: string | number) => `/api/school/discounts/rates/${id}`,
            GET_ALL: '/api/school/discounts/rates',
            SEARCH: (params: string) => `/api/school/discounts/rates/search?${params}`,
            GET_BY_ID: (id: string | number) => `/api/school/discounts/rates/${id}`,
            GET_BY_CAMPUS_YEAR: (campusId: string | number, academicYearId: string | number) => `/api/school/discounts/rates/byCampusYear?campusId=${campusId}&academicYearId=${academicYearId}`,
            GET_BY_CAMPUS: (campusId: string | number) => `/api/school/discounts/rates/byCampus?campusId=${campusId}`,
            GET_BY_ACADEMIC_YEAR: (academicYearId: string | number) => `/api/school/discounts/rates/byAcademicYear?academicYearId=${academicYearId}`,
            ACTIVATE: (id: string | number) => `/api/school/discounts/rates/${id}/activate`,
            DEACTIVATE: (id: string | number) => `/api/school/discounts/rates/${id}/deactivate`,
        }
    },
    LOOKUP: {
