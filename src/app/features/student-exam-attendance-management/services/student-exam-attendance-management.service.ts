...
export class StudentExamAttendanceManagementService {
    ...
    getAttendanceBySubject(subjectId: string | number): Observable<any> {
        const url = `${this.baseUrl}${API_ENDPOINTS.ACADEMIC.RESULTS.EXAM_ATTENDANCE.GET_BY_SUBJECT(subjectId)}`;
